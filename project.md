...
<h2>Course &amp; Competition Projects</h2>
...
<div class="pub-card">
  ...
  <div class="pub-grid">
    <div style="display:flex;align-items:center;justify-content:center;background:#f5f5f5;border-radius:4px;min-height:120px;font-size:2em;">🎵</div>
    <div>
